...
public enum ErrorCode {
     ...
     * 优夹相关错误码
     */
    BIZ4001("B4001", "保存收藏夹失败"), BIZ4002("B4002", "找不到优夹"), BIZ4003("B4003", "优夹已经存在"), BIZ4004("B4004", "缺少优夹id"),
    ...
    BIZ2001("B2001", "添加用户收藏失败"), BIZ2002("B2002", "找不到用户收藏信息"), BIZ2003("B2003", "新增喜欢数失败"), BIZ2004("B2004",
            "新增人气数失败"), BIZ2005("B2005", "新增转录数失败"), BIZ2006("B2006", "收录已经存在"), BIZ2007("B2007", "超时,生成缩略图失败"),
